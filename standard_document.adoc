:Title: Volume 8: OGC CDB Spatial Reference System Guidance (Best Practice)
:titletext: Volume 8: OGC CDB Spatial Reference System Guidance (Best Practice)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
include::clause_6_cdb_approach.adoc[]

include::clause_7_the_three_systems.adoc[]
