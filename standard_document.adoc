...
:titletext: Volume 8: CDB Spatial and Coordinate Reference Systems Guidance
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/BP/CDB-SRF/1.1
...
|Internal reference number of this OGC(R) document:        16-011r4
|Version: 1.1
